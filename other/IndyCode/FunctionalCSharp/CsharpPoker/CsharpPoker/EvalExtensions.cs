...
namespace CsharpPoker
{
    public static class EvalExtensions
    {
        ...
        *   The ToPairs extension method is a specialized mapping method to convert from
        *   IEnumerable<Card> to IEnumerable<KeyValuePair<CardValue, int>> (cards, to counted pairs)
